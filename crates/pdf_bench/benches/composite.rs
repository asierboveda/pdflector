...
use pdf_core::{Annotation, AnnotationSet, Color, Highlight, Rect, Stroke, ViewTransform, composite_annotations};
...
fn bench_composite(c: &mut Criterion) {
    ...
    for (strokes, hls) in cases {
        ...
        for i in 0..strokes {
            ...
            let s = Stroke::new(vec![(30.0, y), (400.0, y+4.0)], 2.5, Color{r:255,g:0,b:0,a:200}).unwrap();
            set.add(0, Annotation::Stroke(s));
        }
        for i in 0..hls {
            let y = 20.0 + (i % 60) as f32 * 14.0;
            set.add(0, Annotation::Highlight(Highlight{ rects: vec![Rect::new(30.0, y, 180.0, 12.0)], color: Color{r:255,g:240,b:0,a:128}}));
        }
