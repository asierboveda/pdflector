...
> El trabajo pendiente se rastrea en GitHub Issues; `docs/plan/` (el roadmap de fases A-F que
> sustituyó a `PLAN.md`) se retiró el 2026-09-24 por la misma razón (recuperable con
> `git log -- docs/plan`).
